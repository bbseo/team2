...
const GangseguLogo = styled.img`
    ...
    const GangseguTitle = styled.span`
    width: 17.5rem;
    height: 7.5;
    margin-left: 32rem;
    font-family: Inter;
...
function Gangsegu({setWishid, setWishTest, onAdd}) {
...
const [ button, setButton ] = useState('MORE');
    ...
    return(
      ...
      <div>
        ...
        <FoodHeader/>
        <GangseguLogo src={GangseguImg}/>
        <GangseguTitle>Gangsegu</GangseguTitle>
          <GangseguLine />
